...
const voidCode = require('./../../controllers/voidCodeController'); 
const pantryMessage = require('./../../controllers/pantryMessageController'); 
const functionAuthority = require('./../../controllers/functionAuthorityController'); 
const functionShortCuts = require('./../../controllers/functionShortCutsController'); 
